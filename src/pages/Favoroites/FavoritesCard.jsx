...
const FavoritesCard = ({phone}) => {
    ...
    return (
      ...
      <div className="relative flex flex-col sm:flex-row md:flex-col lg:flex-row justify-center items-center w-full  rounded-xl bg-white bg-clip-border text-gray-700 shadow-md p-5">
        ...
        <div className="text-center sm:text-left md:text-center lg:text-left">
          <p className="block font-sans text-xl font-medium leading-relaxed text-blue-gray-900 antialiased">
            ...
            <p className="block font-sans text-base font-medium leading-relaxed text-blue-gray-900 antialiased my-1">
              Price: ${price}
            </p>
